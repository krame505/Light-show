...
#define ID_MA  0x01  //full assignment with auto-fade
typedef struct {
...
#define ID_PNA 0x31  // send command PWM command to Arduino N with auto-fade
typedef struct {
...
#define ID_PNCA 0x41  // send command PWM command to Arduino N channel C with auto-fade
typedef struct {
	uint8_t id;	// message ID should be set to ID_PN
	uint8_t N;	// Arduino number
